...
export function BunLogo({ className = '', svgColor = 'none', uniqueId }: SVG_Component_props) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 70" fill={svgColor} id={uniqueId}>
...
export function BunTextLogo({ className = '', svgColor = 'currentColor', uniqueId }: SVG_Component_props) {
  return (
