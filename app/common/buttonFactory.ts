...
export const thirdButtonClassName =
  'rounded-lg px-5 py-2.5 text-gray-100 bg-slate-400 font-semibold hover:bg-slate-600 hover:text-gray-100 w-full max-w-button flex items-center justify-center bg-opacity-95 backdrop-blur-sm shadow-xl gap-2';
